...
$(function () {
  ...
  if (cookies.indexOf("acceptCookies") > -1)
    return;
  ...
  div.innerHTML = "This site uses cookies with google analytics. If you agree to our use of cookies, please <a href='javascript:closeCookies()'>close this message</a>";
  $("body").append(div);
});
